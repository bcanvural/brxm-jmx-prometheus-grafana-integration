...
METRICS_OPTS="-javaagent:/brxm/bin/jmx_prometheus_javaagent-0.12.0.jar=${METRICS_PORT}:/brxm/bin/config.yaml"

CATALINA_OPTS="${JVM_OPTS} ${VGC_OPTS} ${REP_OPTS} ${DMP_OPTS} ${L4J_OPTS} ${METRICS_OPTS}"
